...
3. Write a comprehensive spec following the master spec template at `docs/EXAMPLE-MASTER-SPEC.md` (WebForge root)
4. **Output the spec to `docs/MASTER-SPEC.md` inside the product directory** (`projects/{product-name}/docs/MASTER-SPEC.md`)
5. Also record the spec path in `context/progress.md`
