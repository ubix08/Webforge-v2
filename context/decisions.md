...
| 2026-05-23 | Split wasm-agent into wasm-ui-agent + wasm-coder-agent | Original single agent had excessive scope | Cleaner handoff (later superseded by 5-agent restructure — 2026-05-28) |
| 2026-05-28 | Merged into 5 general agents (wasm-ui + wasm-coder + ui + coder → implement-agent) | 8 specialists → 5 generalists reduces complexity; pipeline specialization via context files | implement-agent handles both pipelines; context files specialize per pipeline |
